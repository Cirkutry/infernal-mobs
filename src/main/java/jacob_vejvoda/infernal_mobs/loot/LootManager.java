...
public class LootManager {
	...
	/**
	 * Replaces variables in command strings with actual values Available variables:
	 * - player: Player's name - worldName: Name of the player's current world -
	 * playerX: Player's X coordinate (rounded) - playerY: Player's Y coordinate
	 * (rounded) - playerZ: Player's Z coordinate (rounded)
	 */
