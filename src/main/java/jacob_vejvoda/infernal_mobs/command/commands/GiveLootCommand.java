...
import jacob_vejvoda.infernal_mobs.command.CommandUtils;
		...
		try {
			...
			if (p != null) {
				...
				if (i != null) {
					...
					sender.sendMessage(localeManager.getMessage("commands.giveloot.success-player", p.getName(),
							String.valueOf(index)));
				} else {
					sender.sendMessage(localeManager.getMessage("commands.giveloot.success-commands-player",
							String.valueOf(index), p.getName()));
				}
				return true;
			} else {
